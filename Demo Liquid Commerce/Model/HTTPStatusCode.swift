...
/// It includes codes from IETF internet standards, other IETF RFCs, 
...
public enum HTTPStatusCode: Int, Error {
    ...
    /// - alreadyReported: The members of a DAV binding have already been enumerated in
    /// a previous reply to this request, and are not being included again.
    case alreadyReported = 208

    /// - IMUsed: The server has fulfilled a request for the resource, and the response is a representation of
    ...
    /// - requestHeaderFieldsTooLarge: The server is unwilling to process the request because
    ///  either an individual header field, or all the header fields collectively, are too large.
    case requestHeaderFieldsTooLarge = 431

    /// - noResponse: Used to indicate that the server has returned no information to the client 
    /// and closed the connection.
    case noResponse = 444

    /// - unavailableForLegalReasons: A server operator has received a legal demand to deny access to a resource 
    /// or to a set of resources that includes the requested resource.
    case unavailableForLegalReasons = 451

    /// - SSLCertificateError: An expansion of the 400 Bad Request response code, 
    /// used when the client has provided an invalid client certificate.
    case SSLCertificateError = 495

    /// - SSLCertificateRequired: An expansion of the 400 Bad Request response code, 
    ...
    /// - internalServerError: A generic error message, 
    ...
    /// - badGateway: The server was acting as a gateway 
    ...
    /// - gatewayTimeout: The server was acting as a gateway or proxy 
