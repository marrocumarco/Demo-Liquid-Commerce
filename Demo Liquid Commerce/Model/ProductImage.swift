...
struct ProductImage: Codable {
    ...
    init(from decoder: Decoder) throws {
        let container: KeyedDecodingContainer<ProductImage.CodingKeys> = try decoder.container(
            keyedBy: ProductImage.CodingKeys.self)
    ...
    func encode(to encoder: Encoder) throws {
        var container: KeyedEncodingContainer<ProductImage.CodingKeys> = encoder.container(
            keyedBy: ProductImage.CodingKeys.self)
